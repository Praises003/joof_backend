...
const { getText, updateVision, updateBanner, updateMission, updateWelcome, updateSec, updateProf, updateProv, updateDed, updateHighly, updateAccess, updateSuccess, updateFac, updateTextOne, updateTextTwo, updateTextThree, updateTextFour, updateTextFive, updateTextSix, updateAbout, updateRoom, updateUnInter, updateSecurity, updateEvent } = require('../controllers/textsContoller')
...
router.put("/uninter", updateUnInter)
